...
Организация связывается с проектами через `Project.organization`, но проект всегда имеет персонального `owner`. `organization` опциональна: талант может создать личный проект и одновременно оставаться талантом, участником других проектов и, при наличии полномочий, представителем организации.
...
| Создать личный проект | любой авторизованный пользователь; организация не требуется, роль `project_lead` добавляется к существующим ролям |
