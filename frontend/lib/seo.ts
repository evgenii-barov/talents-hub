...
export const DEFAULT_TITLE =
  "Talents Hub — международная сеть талантов ШОС";
export const DEFAULT_DESCRIPTION =
  "Международная профессиональная сеть для выпускников, экспертов, организаций и участников стран ШОС: находите таланты, проекты и партнёров для сотрудничества.";
